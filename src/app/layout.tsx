...
export const metadata: Metadata = {
  title: "Mohamed Bouabidi | Data Scientist",
  description:
    "Mohamed Bouabidi is a Data Scientist specializing in machine learning, AI solutions, and data analytics with experience in developing predictive models and data-driven applications.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
